...
**-U user** - указывается пользователь user . Данный пользователь должен обладать правами репликации в БД и прописан в pg_hba.conf
...
**-p порт** - указывается порт подключения        
 ...
 ### Запросы в БД по работе pg_basebackup
